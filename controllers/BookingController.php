...
class BookingController {
    ...
    public function create() {
        ...
        try {
            ...
            $stmt = $this->pdo->prepare("
                INSERT INTO tb_booking (kode_booking, user_id, mobil_id, tanggal_booking, jam_booking, keluhan, total_harga, status)
                VALUES (?, ?, ?, ?, ?, ?, ?, 'menunggu')
            ");
            $stmt->execute([$kodeBooking, $userId, $mobilId, $tanggal, $jam, $keluhan, $totalHarga]);
